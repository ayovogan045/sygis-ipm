...
class City extends \entities\City implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\City' . "\0" . 'id', '' . "\0" . 'entities\\City' . "\0" . 'wording', '' . "\0" . 'entities\\City' . "\0" . 'description', '' . "\0" . 'entities\\City' . "\0" . 'state', '' . "\0" . 'entities\\City' . "\0" . 'country', '' . "\0" . 'entities\\City' . "\0" . 'person_infos', 'version'];
        }
    ...
    public function getCountryWording()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCountryWording', []);

        return parent::getCountryWording();
    }
