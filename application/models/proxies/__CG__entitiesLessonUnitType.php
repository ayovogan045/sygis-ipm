 ...
 */
class LessonUnitType extends \entities\LessonUnitType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\LessonUnitType' . "\0" . 'id', '' . "\0" . 'entities\\LessonUnitType' . "\0" . 'wording', '' . "\0" . 'entities\\LessonUnitType' . "\0" . 'code', '' . "\0" . 'entities\\LessonUnitType' . "\0" . 'lesson_units', '' . "\0" . 'entities\\LessonUnitType' . "\0" . 'state', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LessonUnitType $proxy) {
