 ...
 */
class Candidat extends \entities\Candidat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\Candidat' . "\0" . 'id', '' . "\0" . 'entities\\Candidat' . "\0" . 'state', '' . "\0" . 'entities\\Candidat' . "\0" . 'validated', '' . "\0" . 'entities\\Candidat' . "\0" . 'person_info', '' . "\0" . 'entities\\Candidat' . "\0" . 'registrations', 'version'];
        }
    ...
    public function getPerson_info()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPerson_info', []);

        return parent::getPerson_info();
    }
    ...
    public function setPerson_info($person_info)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPerson_info', [$person_info]);

        return parent::setPerson_info($person_info);
    }
