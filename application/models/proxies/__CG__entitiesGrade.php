 ...
 */
class Grade extends \entities\Grade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\Grade' . "\0" . 'id', '' . "\0" . 'entities\\Grade' . "\0" . 'wording', '' . "\0" . 'entities\\Grade' . "\0" . 'code', '' . "\0" . 'entities\\Grade' . "\0" . 'level', '' . "\0" . 'entities\\Grade' . "\0" . 'mentions', '' . "\0" . 'entities\\Grade' . "\0" . 'state', 'version'];
        }
