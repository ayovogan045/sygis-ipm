 ...
 */
class Mention extends \entities\Mention implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\Mention' . "\0" . 'id', '' . "\0" . 'entities\\Mention' . "\0" . 'wording', '' . "\0" . 'entities\\Mention' . "\0" . 'code', '' . "\0" . 'entities\\Mention' . "\0" . 'grade', '' . "\0" . 'entities\\Mention' . "\0" . 'specialities', '' . "\0" . 'entities\\Mention' . "\0" . 'state', 'version'];
        }
    ...
    public function getGradeWording()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradeWording', []);

        return parent::getGradeWording();
    }
