 ...
 */
class AcademicYear extends \entities\AcademicYear implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'id', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'wording', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'code', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'current', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'state', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'semesters', '' . "\0" . 'entities\\AcademicYear' . "\0" . 'registrations', 'version'];
        }
