 ...
 */
class FeeType extends \entities\FeeType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\FeeType' . "\0" . 'id', '' . "\0" . 'entities\\FeeType' . "\0" . 'wording', '' . "\0" . 'entities\\FeeType' . "\0" . 'code', '' . "\0" . 'entities\\FeeType' . "\0" . 'description', '' . "\0" . 'entities\\FeeType' . "\0" . 'state', '' . "\0" . 'entities\\FeeType' . "\0" . 'fees', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FeeType $proxy) {
