 ...
 */
class LessonUnitMention extends \entities\LessonUnitMention implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\LessonUnitMention' . "\0" . 'id', '' . "\0" . 'entities\\LessonUnitMention' . "\0" . 'wording', '' . "\0" . 'entities\\LessonUnitMention' . "\0" . 'code', '' . "\0" . 'entities\\LessonUnitMention' . "\0" . 'lesson_units', '' . "\0" . 'entities\\LessonUnitMention' . "\0" . 'state', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LessonUnitMention $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getLesson_units()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLesson_units', []);

        return parent::getLesson_units();
    }
     ...
     * {@inheritDoc}
     */
    public function setLesson_units($lesson_units)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLesson_units', [$lesson_units]);

        return parent::setLesson_units($lesson_units);
    }
