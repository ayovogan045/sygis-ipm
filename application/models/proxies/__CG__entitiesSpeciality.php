 ...
 */
class Speciality extends \entities\Speciality implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\Speciality' . "\0" . 'id', '' . "\0" . 'entities\\Speciality' . "\0" . 'wording', '' . "\0" . 'entities\\Speciality' . "\0" . 'code', '' . "\0" . 'entities\\Speciality' . "\0" . 'mention', '' . "\0" . 'entities\\Speciality' . "\0" . 'lesson_units', '' . "\0" . 'entities\\Speciality' . "\0" . 'speciality_person_infos', '' . "\0" . 'entities\\Speciality' . "\0" . 'state', 'version'];
        }
    ...
    public function getMentionWording()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMentionWording', []);

        return parent::getMentionWording();
    }
