 ...
 */
class ClassUnit extends \entities\ClassUnit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'id', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'wording', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'code', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'level', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'classunitfees', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'classrooms', '' . "\0" . 'entities\\ClassUnit' . "\0" . 'state', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassUnit $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setClassunitfees($classunitfees)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassunitfees', [$classunitfees]);

        return parent::setClassunitfees($classunitfees);
    }
    ...
    public function setClassrooms($classrooms)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassrooms', [$classrooms]);

        return parent::setClassrooms($classrooms);
    }
    ...
    public function getLevelWording()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLevelWording', []);

        return parent::getLevelWording();
    }
