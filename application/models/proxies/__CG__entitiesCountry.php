...
class Country extends \entities\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\Country' . "\0" . 'id', '' . "\0" . 'entities\\Country' . "\0" . 'wording', '' . "\0" . 'entities\\Country' . "\0" . 'shortWording', '' . "\0" . 'entities\\Country' . "\0" . 'code', '' . "\0" . 'entities\\Country' . "\0" . 'nationality', '' . "\0" . 'entities\\Country' . "\0" . 'cities', '' . "\0" . 'entities\\Country' . "\0" . 'person_infos', '' . "\0" . 'entities\\Country' . "\0" . 'state', 'version'];
        }
    ...
    public function getShortWording()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShortWording', []);

        return parent::getShortWording();
    }
    ...
    public function setShortWording($shortWording)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShortWording', [$shortWording]);

        return parent::setShortWording($shortWording);
    }
