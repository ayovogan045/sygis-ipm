 ...
 */
require_once APPPATH . 'models/dao/IServiceTypeDAO.php';
require_once APPPATH . 'third_party/dmap/dmapimpl/DAO.php';

/**
 * Description of ServiceTypeDAO
 *
 * @author Xlencia
 * @Implement the data access object's interface of ServiceType entity
 */
class ServiceTypeDAO extends DAO implements IServiceTypeDAO {
