 ...
 * @Entity
 * @MappedSuperclass
 * @Table(name="lesson_unit_types")
 * @An abstract objet which represent the database of LessonUnitType in datatable
 */
class LessonUnitType extends Baseentity implements \Serializable {
    ...
    /**
     * @OneToMany(targetEntity="lessonunit", mappedBy="lesson_unit_type")
     * */
