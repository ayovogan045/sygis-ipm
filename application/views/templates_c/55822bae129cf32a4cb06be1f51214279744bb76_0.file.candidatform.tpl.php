<?php
/* Smarty version 3.1.40, created on 2023-09-14 22:26:27
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_65038893b89983_11525503',
...
function content_65038893b89983_11525503 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="row">
            <div class="col-sm-4 panel-title panel-default">
                <fieldset class="fieldset fi">
                    <legend class="">Identité</legend>
                    <div class="form-group col-sm-12 required">
                        <label class="col-sm-8 control-label no-padding-right" for="<?php echo $_smarty_tpl->tpl_vars['lastname']->value;?>
"> 
...
" required="true" />
            ...
            <div class="col-sm-4 panel-title panel-default">
                <fieldset class="fieldset fi">
                    <legend class="">Personne à contacter en cas d'urgence</legend>
                    <div class="form-group col-sm-12 required">
...
" required="true" />
        ...
        <div class="row">
            <div class="col-sm-4 panel-title panel-default">
                <fieldset class="fieldset fi">
                    <legend class="">Renseignement de baccalaureat</legend>
                    <div class="form-group col-sm-12 required">
                        <label class="col-sm-4 control-label no-padding-right" for="<?php echo $_smarty_tpl->tpl_vars['phone']->value;?>
"> 
                            <span><?php echo $_smarty_tpl->tpl_vars['phonelabel']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="col-sm-12 hr hr-16 hr-dotted"></div>
                    <div class="col-sm-12 panel-title panel-default">
                        <fieldset class="fieldset fi">
                            <legend class="">Financement de vos études</legend>
                            <div class="form-group col-sm-12 required">
                                <label class="col-sm-4 control-label no-padding-right" for="<?php echo $_smarty_tpl->tpl_vars['nationality']->value;?>
"> 
                                    <span><?php echo $_smarty_tpl->tpl_vars['nationalitylabel']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="col-sm-12 panel-title panel-default">
                        <fieldset class="fieldset fi">
                            <legend class="">Comment avez-vous appris</legend>
                            <div class="form-group col-sm-12 required">
                                <label class="col-sm-4 control-label no-padding-right" for="<?php echo $_smarty_tpl->tpl_vars['bloodgroup']->value;?>
"> 
                                    <span><?php echo $_smarty_tpl->tpl_vars['bloodgrouplabel']->value;?>
...
/user.png" id="preview" class="img-thumbnail">
        ...
        <div class="row">           
            <div class="col-sm-12 panel-title panel-default">
                <fieldset class="fieldset fi">
                    <legend class="">Etude antérieure</legend>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>PARCOURS</th>
                                    <th>Ville/PAYS</th>
                                    <th>NOMBRE DE CREDIT CAPITALISE</th>
                                    <th>DIPLOME</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div class="row">
            <div class="col-sm-12 panel-title panel-default">
                <fieldset class="fieldset fi">
                    <legend class="">Expériences professionnelles</legend>
